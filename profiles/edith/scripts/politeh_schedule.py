...
# 5 недель, не 4: месяц вперёд с запасом, чтобы граница месяца не обрезала
# последнюю неделю. Изначально стояло 3 — Михаил (2026-08-24): «каждую
# неделю выгружалось новое расписание на месяц вперёд». Крон и так гоняет
# синхронизацию каждое воскресенье (см. docs/politeh-schedule.md) — окно
# нужно было просто расширить, отдельного бага в самой логике не было.
